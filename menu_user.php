  ...
  <body style="background:linear-gradient(#c27872,#ecbab2 , #cfa299,#c27872)">
    ...
    <header >
      <nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #c27872">
        <a class="navbar-brand" href="menu_user.php">MagicCosmetic</a>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="photo/pro3.png" alt="First slide">
            <div class="container">
     ...
     <a href="menu_user.php"> <h1 style="text-align: center;"><span  class="btn btn-lg font2" style="background-color: #ff5454;color: #ffffff; font-size: 36px;">สินค้าทั้งหมด</span></h1></a>
